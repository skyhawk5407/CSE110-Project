    ...
    <b-jumbotron>
      <template slot="lead">
        <div style="margin-top: 20px">
          ...
          <b-alert
            variant="success"
            :show="show_good_account_message"
          >{{ account_good_alert_message }}</b-alert>
          ...
          <div style="margin-top: 20px">
            ...
            <b-alert
              variant="success"
              :show="show_good_password_alert"
            >{{ account_good_password_message }}</b-alert>
          </div>
        </div>
      </template>
    </b-jumbotron>
...
export default {
  ...
  methods: {
    ...
    async delete_account() {
      try {
        let response = await api.users.delete_account.delete(
          this.$store.state.username,
          this.$store.state.password
        );
