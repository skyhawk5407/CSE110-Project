...
<template>
  <div>
    <b-jumbotron>
      <template slot="header">Rules</template>
      <b-card>
      ...
      <b-row class="p-3 my-1" align-h="center">
        ...
        <br>
        <b-button class="btn btn-primary btn-lg" @click="$refs.file.click()">Upload Rules</b-button>
      </b-row>
      <b-row class="p-3 my-1" align-h="center">
        <b-card>
...
export default {
  ...
  data() {
    return {
      url: "<h1>Some initial content</h1>",
      htmlForEditor: null
    };
  },
  methods: {
