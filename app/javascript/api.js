...
export default {
    ...
    expenses: {
        ...
        post: (payer_id, issuer_id, title, description, amount, email, password) => axios.post('/apartments/expenses', {
            payer_id: payer_id,
            issuer_id: issuer_id,
            title: title,
    ...
    notification: {
        ...
        post: (title, message, anonymous, email, password) => axios.post('/apartments/notifications', {
            title: title,
            message: message,
            anonymous: anonymous,
        }, {
